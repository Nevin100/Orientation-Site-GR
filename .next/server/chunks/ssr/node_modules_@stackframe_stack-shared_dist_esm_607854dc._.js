...
var StackClientInterface = class {
    ...
    async getOAuthProvider(userId, providerId, session, requestType = "client") {
        const sendRequest = requestType === "client" ? this.sendClientRequest : this.sendServerRequest;
        const response = await sendRequest.call(this, `/oauth-providers/${userId}/${providerId}`, {
            method: "GET"
        }, session, requestType);
        return response.json();
    }
    async listOAuthProviders(options = {}, session, requestType = "client") {
        const sendRequest = requestType === "client" ? this.sendClientRequest : this.sendServerRequest;
        ...
        const response = await sendRequest.call(this, `/oauth-providers${queryParams.toString() ? `?${queryParams.toString()}` : ""}`, {
            method: "GET"
        }, session, requestType);
        const result = await response.json();
        return result.items;
    }
    async deleteOAuthProvider(userId, providerId, session, requestType = "client") {
        const sendRequest = requestType === "client" ? this.sendClientRequest : this.sendServerRequest;
        const response = await sendRequest.call(this, `/oauth-providers/${userId}/${providerId}`, {
            method: "DELETE"
        }, session, requestType);
    ...
    async getItem(options, session) {
        ...
        const response = await this.sendClientRequest(`/payments/items/${customerId}/${options.itemId}`, {}, session);
        return await response.json();
    }
...
var StackServerInterface = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$interface$2f$client$2d$interface$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StackClientInterface"] {
    ...
    async sendEmail(options) {
        const res = await this.sendServerRequestAndCatchKnownError("/emails/send-email", {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$known$2d$errors$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["KnownErrors"].RequiresCustomEmailServer,
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$known$2d$errors$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["KnownErrors"].SchemaError,
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$known$2d$errors$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["KnownErrors"].UserIdDoesNotExist
        ]);
        if (res.status === "error") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stackframe$2f$stack$2d$shared$2f$dist$2f$esm$2f$utils$2f$results$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Result"].error(res.error);
        }
    ...
    async updateItemQuantity(customerId, itemId, data) {
        ...
        await this.sendServerRequest(`/payments/items/${customerId}/${itemId}/update-quantity?${queryParams.toString()}`, {
            method: "POST",
            headers: {
                "content-type": "application/json"
            },
...
"[project]/node_modules/@stackframe/stack-shared/dist/esm/index.js [app-rsc] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_%40stackframe_stack-shared_dist_esm_607854dc._.js.map