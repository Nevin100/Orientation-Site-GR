    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-16 bg-black">
      <div className="max-w-screen-lg">
        ...
        <motion.h2
          ...
          bg-gradient-to-r from-orange-400 via-green-400 to-cyan-400  bg-clip-text text-transparent"
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          {faq.map(({ question, answer, icon: Icon }, i) => (
            ...
            >
              ...
              bg-gradient-to-r from-orange-500 via-green-400 to-cyan-400  text-white shadow-md"
              >
                <Icon className="w-5 h-5" />
              </div>
              <div
                className="mt-5 mb-2 text-[1.35rem] font-semibold tracking-tight 
              bg-gradient-to-r from-orange-500 via-green-400 to-cyan-400 bg-clip-text text-transparent"
              >
                {question}
              </div>
